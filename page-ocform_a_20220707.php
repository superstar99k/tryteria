<?php /**
* Template Name: ocform_a?20220707
 */
?>
...
<div class="memo">下記フォームにご記入いただいたメールアドレス宛に商品カタログへのリンクをお送りします。</div>

	<?php echo do_shortcode('[contact-form-7 id="4925"]') ?>
	<div id="wpcf7-f4925-o1"></div>
